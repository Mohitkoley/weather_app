...
import 'package:weather_app/whether.dart';
void main() {
  runApp(MyApp());
}
            ...
            Column(
              ...
              children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("c",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,fontFamily: "IBM",color: color
                                  ),
                                  ),
                                ],
                              ),
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text("Jamshedpur",style: TextStyle(
                      fontSize: 30,
                      letterSpacing: 2,
                      fontFamily: "Poppins",
                      color: color,
                    ...
                    ToggleButtons( borderRadius: BorderRadius.circular(50),
                    ...
                    Container(
                      ...
                      child: Text(whetherList[i].day,style: TextStyle(
      ...
      scrollDirection: Axis.horizontal,),
            ...
            Positioned(right: 20,
                       top: MediaQuery.of(context).size.height*0.2,
                        child: Container(
                          child: Text(whether,style: TextStyle(
                            fontSize: 25,fontFamily: "IBM",color: color,
                           ),
                          ),
                        ),),
          ],
